...
public class ViewUtil {
    ...
    public static boolean isTranslucentStatus(final Window window) {
    ...
    static boolean isFitsSystemWindows(final Window window) {
        //noinspection SimplifiableIfStatement
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            return ((ViewGroup) window.findViewById(android.R.id.content)).getChildAt(0).
